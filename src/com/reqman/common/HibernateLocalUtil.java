	  ...
	  private static SessionFactory sessionFactory;
	    ...
	    public static SessionFactory getSessionFactory() {
	        if (sessionFactory == null) {
	    	    ...
	    	    configuration.setProperty("hibernate.connection.url", "jdbc:postgresql://ec2-204-236-239-225.compute-1.amazonaws.com:5432/dffv8dunka453i");
	    	    configuration.setProperty("hibernate.connection.username", "qhpussfdkavbgm");
	    	    configuration.setProperty("hibernate.connection.password", "250353aa68a97263e3970b023ff83c11d8630addf581efb5df354c729f9a1362");
