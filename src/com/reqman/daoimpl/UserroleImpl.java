...
public class UserroleImpl implements UserroleInterface{
	...
	@Override
	public List<UserroleVo> getuserroleDetails(String userName)
			throws Exception {
			...
			try {
				...
				if (usersTemp != null) {
					...
					List<Userroles> userrolelist = (List<Userroles>) session
					...
					String	username = "";
						for (Userroles userroleDB : userrolelist) {			
							...
							{
								rolename = userroleDB.getRoles().getName() != null 
										? userroleDB.getRoles().getName() : "" ;										
							}
							
							if(userroleDB != null && userroleDB.getUsers() != null)
							{
								username = userroleDB.getUsers().getEmailid() != null 
										? userroleDB.getUsers().getEmailid()  : "" ;										
							}
