...
public class Monthlyemail {
	...
	public String monthlyGridContent(String To, String emailid) throws Exception, IOException {
		...
		try {
			...
			monthlysummeryemailVo = newrequestInterface.getTotalaveragebyrequester(emailid.toLowerCase().trim());
			...
			for (MonthlysummeryemailVo monthlysummeryemailVoDB : monthlysummeryemailVo) {
				...
				sb.append("<span>");
				sb.append("Total Number Of Requests Received By You:&nbsp;&nbsp;&nbsp;");
				sb.append("</span>");
				sb.append(monthlysummeryemailVoDB.getTotalrequestreceive());
				sb.append("<br></br>");
				sb.append("<hr></hr>");
				sb.append("<br></br>");

				sb.append("<span>");
				sb.append("Average Rating Of Requests By You On Team Members:&nbsp;&nbsp;&nbsp;");
				sb.append("</span>");
				...
				sb.append("<span>");
				sb.append("Average Rating Of Requests On You By Requesters:&nbsp;&nbsp;&nbsp;");
				sb.append("</span>");
				sb.append(monthlysummeryemailVoDB.getFeedbacktoreceive());
				sb.append("<br></br>");
				sb.append("<hr></hr>");
				sb.append("<br></br>");
	...
	/*
	 * public static void main(String args[]) throws Exception { BigInteger
	 * emailList1=null; BigInteger emailList2=null; Monthlyemail gr=new
	 * Monthlyemail();
	 * 
	 * gr.sendmailMonthly("hemantraghav012@gmail.com",
	 * "hemantraghav012@gmail.com");
	 * 
	 * 
	 * 
	 * }
