...
public class sendEmailonfriend {
	public String addnewfriend(String To, String emailid,  String friendemailid){
		...
		try{
			...
			sb.append("<br>");			
			sb.append("Your team member " + friendemailid + " has invited you to use this time saving productive tool  This tool will help  save lots of time, not just for you but also your other team members.");
			sb.append("<br>");			
